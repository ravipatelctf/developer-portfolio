    ...
    return (
        <div className="container py-5 my-5">
            <section>
                ...
                <p className="text-white-50 fs-3">Full Stack Web Developer</p>
                ...
                <div className="d-flex gap-2">
                    <a href="https://ravipatelctf@gmail.com" target="_blank" className="btn btn-success fw-bold py-2 px-4">Contact Me</a>
                    <a href="https://drive.google.com/drive/folders/1lZZxK14I-rh2M-bVVVn11RHaQST-jvGT?usp=drive_link" target="_blank" className="btn btn-outline-secondary fw-bold py-2 px-4">Resume</a> 
                </div>
            </section>
        </div>
    );
